<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link active font-text" aria-current="page" href="#">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-text" aria-current="page" href="#">About Us</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-text" aria-current="page" href="#">Privacy Policy</a>
            </li>
            <li class="nav-item">
